...
<tbody>
<?php 
$query=mysqli_query($bd, "select tblcomplaints.complaintNumber,tblcomplaints.regDate,users.fullName as name from tblcomplaints join users on users.id=tblcomplaints.userId where tblcomplaints.status is null ");
